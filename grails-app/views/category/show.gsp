                    ...
                    <div class="row">
                        <div class="col-md-12 mb-md-0 mb-4 ">
                            <div class="card card-body card-plain border-radius-lg align-items-lg-start col-12 ">
                                <g:form resource="${this.category}" method="DELETE" class="col-12">
                                    <g:render template="form"/>
                                    <fieldset class="buttons">
                                        <g:link class="btn btn-outline-secondary" action="index" resource="${this.category}"><g:message code="default.button.cancel.label" default="Abbruch" /></g:link>
                                        <g:link class="btn btn-info" action="edit" resource="${this.category}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
